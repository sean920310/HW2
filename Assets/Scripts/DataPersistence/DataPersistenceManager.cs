...
public class DataPersistenceManager : MonoBehaviour
{
    ...
    {
        // return right away if data persistence is disabled
        if (disableDataPersistence || SceneManager.GetActiveScene().buildIndex == 0)
        {
            Debug.LogWarning("disableDataPersistence || SceneManager.GetActiveScene().buildIndex == 0 + buildIndex "+ SceneManager.GetActiveScene().buildIndex.ToString());
            return;
        }
        ...
        gameData.playerCurrentScene = SceneManager.GetActiveScene().buildIndex;
