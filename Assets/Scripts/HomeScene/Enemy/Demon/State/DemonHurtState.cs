...
public class DemonHurtState : DemonBaseState
{
    private Color hurtColor;
    public DemonHurtState(DemonStateManager context, DemonStateFactory factory)
    ...
    {
        _context.Material.shader = _context.GlowingShader;
    }
