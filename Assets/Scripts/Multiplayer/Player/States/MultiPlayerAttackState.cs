...
public class MultiPlayerAttackState : MultiPlayerBaseState
{
    ...
    public MultiPlayerAttackState(MultiPlayerStatesManager context, MultiPlayerStateFactory factory)
