...
public class MultiPlayerBlockingState : MultiPlayerBaseState
{
    public MultiPlayerBlockingState(MultiPlayerStatesManager context, MultiPlayerStateFactory factory)
