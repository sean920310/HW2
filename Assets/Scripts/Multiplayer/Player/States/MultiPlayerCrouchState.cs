...
public class MultiPlayerCrouchState : MultiPlayerBaseState
{
    public MultiPlayerCrouchState(MultiPlayerStatesManager context, MultiPlayerStateFactory factory)
