...
public class MultiPlayerWallSlideState : MultiPlayerBaseState
{
    public MultiPlayerWallSlideState(MultiPlayerStatesManager context, MultiPlayerStateFactory factory)
